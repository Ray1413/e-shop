...
import type { Route } from "./+types/_app-layout.personal-care-and-health.($category)";
...
export default function PersonalCareCategory({ loaderData }: Route.ComponentProps) {
  return (
    <div>
